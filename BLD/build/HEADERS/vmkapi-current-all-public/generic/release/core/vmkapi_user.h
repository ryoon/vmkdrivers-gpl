 ...
 *                            vmk_UserMap().
 * \param[in]  cartelID       The cartel that owns this mapping.
 ...
 *                               result in the cartel being killed.
...
typedef enum vmk_UserMapType {
   ...
   VMK_USER_MAP_ANON = 2,
   /**
    * \brief Mapping of anonymous memory that may be shared between cartels.
    *
    * Anonymous memory is allocated internally by the system when the pages are
    * first accessed.
    *
 ...
 * vmk_UserUnmap --                                               */ /**
 *
 * \brief Unmap user cartel virtual address space mapped by vmk_UserMap().
 *
 ...
 * vmk_UserPinPage --                                             */ /**
 *
 * \brief Marks the specified VPN in the specified cartel as not
 *        swappable.
 *
 * \note  There is no need to pin pages of type VMK_USER_MAP_MPNS, since
 *        they are by definition pinned as long as they are mapped.
 *
 * \deprecated  In next release, only pages mapped by a call to
 *              vmk_UserMap() with type VMK_USER_MAP_ANON or
 *              VMK_USER_MAP_SHARED will be allowed to pinned this way.
 *
 * \param[in]  cartelID        ID of cartel whose mapping will be pinned.
 ...
 * \retval VMK_INVALID_WORLD   An invalid cartelID was provided.
 *
 ***********************************************************************
 */
 ...
 * vmk_UserUnpinPage --                                           */ /**
 *
 * \brief Marks the specified VPN in the specified cartel as swappable.
 *
 * \note  This VPN must have been pinned by a call to vmk_UserPinPage().
 *
 * \param[in]  cartelID        ID of cartel whose mapping will be
 *                             unpinned.
 ...
 * time it is accessed within the specified cartel. The notification is
 ...
 *
 * \note This VPN must have been mapped by the specified cartel using
 ...
 *
 * \param[in]  cartelID        ID of cartel with mapping.
 ...
 *
 * \param[in]  cartelID        The cartel whose mapping should be
 *                             changed.
