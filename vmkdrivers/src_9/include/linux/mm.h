 ...
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: struct page */
struct page {
};

/**                                          
 *  put_page - decrement the refcount of the page handle
 *  @page: page handle
 *                                           
 *  ESX Deviation Notes:                     
 *  As we don't support such mechanism, we release the page.
 *                                           
 */                                          
...
/**
 *  page_address - page handle to virtual address
 *  @page: page handle
 *
 *  ESX Deviation Notes:                     
