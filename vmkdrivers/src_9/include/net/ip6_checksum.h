...
/*
 * 04/04/2011: Add man page content
 */
 ...
 *  @csum: initial sum (32bit unfolded) to be added in
 *                                           
 *  Aggregate into @csum the computed checksum of @saddr, @daddr, @len and @proto.
 *
 *  RETURN VALUE:
 *  16-bit folded checksum
 *                                           
 */                                          
