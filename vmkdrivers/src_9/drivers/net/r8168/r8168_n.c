...
#ifndef __VMKLNX__
	/* 
	 * this eeprom support was removed from mainline linux driver because it
	 * occasionally resulted in zero'd MAC addresses. a similar issue was
	 * reported on ESX.
	 */
...
#ifndef __VMKLNX__
        /* Checksum offload doesn't work for me */
	dev->features |= NETIF_F_IP_CSUM;
	tp->cp_cmd |= RxChkSum;
#endif
