...
/* Un-comment this to dump dcbx parameters when received from FW */
/* #define BNX2X_DUMP_DCBX 1 */
...
/*******************************************************************************
 * LLDP structure for IOCTL get params
 ******************************************************************************/
...
/*******************************************************************************
 * DCBX structure for IOCTL get params
 ******************************************************************************/
#define DCBX_PARAMS_VER_NUM 2
struct bnx2x_dcbx_params_get {
	...
	struct bnx2x_admin_priority_app_table remote_priority_app_table[16];
	...
	struct bnx2x_admin_priority_app_table local_priority_app_table[16];
	u32 pfc_mismatch;
...
/*******************************************************************************
 * DCBX structure for B10_IOC_SET_DCBX_PARAMS.
 ******************************************************************************/
...
#if defined(INIT_DELAYED_WORK_DEFERRABLE) || defined(INIT_WORK_NAR) || (defined(VMWARE_ESX_DDK_VERSION) && (VMWARE_ESX_DDK_VERSION >= 40000)) /* BNX2X_UPSTREAM */
void bnx2x_dcbx_timeout(struct work_struct *work);
void bnx2x_dcbx_update(struct work_struct *work);
#else
void bnx2x_dcbx_timeout(void *data);
void bnx2x_dcbx_update(void *data);
#endif
