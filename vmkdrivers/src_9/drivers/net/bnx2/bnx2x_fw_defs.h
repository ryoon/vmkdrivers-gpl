...
#define CSTORM_ASSERT_LIST_INDEX_OFFSET (IRO[140].base)
#define CSTORM_ASSERT_LIST_OFFSET(assertListEntry) \
	(IRO[139].base + ((assertListEntry) * IRO[139].m1))
	#define CSTORM_BYTE_COUNTER_OFFSET(sbId,dhcIndex) (IRO[146].base \
	+ ((sbId) * IRO[146].m1) + ((dhcIndex) * IRO[146].m2))
#define CSTORM_ETH_STATS_QUERY_ADDR_OFFSET(pfId) \
	(IRO[142].base + ((pfId) * IRO[142].m1))
#define CSTORM_EVENT_RING_DATA_OFFSET(pfId) \
	(IRO[147].base + (((pfId)>>1) * IRO[147].m1) + (((pfId)&1) * \
	IRO[147].m2))
#define CSTORM_FINAL_CLEANUP_COMPLETE_OFFSET(funcId) \
	(IRO[154].base + ((funcId) * IRO[154].m1))
#define CSTORM_FUNCTION_MODE_OFFSET (IRO[151].base)
#define CSTORM_FUNC_EN_OFFSET(funcId) \
	(IRO[144].base + ((funcId) * IRO[144].m1))
#define CSTORM_IGU_MODE_OFFSET (IRO[152].base)
#define CSTORM_ISCSI_CQ_SIZE_OFFSET(pfId) \
	(IRO[303].base + ((pfId) * IRO[303].m1))
#define CSTORM_ISCSI_CQ_SQN_SIZE_OFFSET(pfId) \
	(IRO[304].base + ((pfId) * IRO[304].m1))
	#define CSTORM_ISCSI_EQ_CONS_OFFSET(pfId,iscsiEqId) \
	(IRO[296].base + ((pfId) * IRO[296].m1) + ((iscsiEqId) * \
	IRO[296].m2))
	#define CSTORM_ISCSI_EQ_NEXT_EQE_ADDR_OFFSET(pfId,iscsiEqId) \
	(IRO[298].base + ((pfId) * IRO[298].m1) + ((iscsiEqId) * \
	IRO[298].m2))
	#define CSTORM_ISCSI_EQ_NEXT_PAGE_ADDR_OFFSET(pfId,iscsiEqId) \
	(IRO[297].base + ((pfId) * IRO[297].m1) + ((iscsiEqId) * \
	IRO[297].m2))
	#define \
	CSTORM_ISCSI_EQ_NEXT_PAGE_ADDR_VALID_OFFSET(pfId,iscsiEqId) \
	(IRO[299].base + ((pfId) * IRO[299].m1) + ((iscsiEqId) * \
	IRO[299].m2))
	#define CSTORM_ISCSI_EQ_PROD_OFFSET(pfId,iscsiEqId) \
	(IRO[295].base + ((pfId) * IRO[295].m1) + ((iscsiEqId) * \
	IRO[295].m2))
	#define CSTORM_ISCSI_EQ_SB_INDEX_OFFSET(pfId,iscsiEqId) \
	(IRO[301].base + ((pfId) * IRO[301].m1) + ((iscsiEqId) * \
	IRO[301].m2))
	#define CSTORM_ISCSI_EQ_SB_NUM_OFFSET(pfId,iscsiEqId) \
	(IRO[300].base + ((pfId) * IRO[300].m1) + ((iscsiEqId) * \
	IRO[300].m2))
...
#define CSTORM_PATH_ID_OFFSET (IRO[157].base)
#define CSTORM_SP_STATUS_BLOCK_DATA_OFFSET(pfId) \
	(IRO[135].base + ((pfId) * IRO[135].m1))
#define CSTORM_SP_STATUS_BLOCK_OFFSET(pfId) \
	(IRO[134].base + ((pfId) * IRO[134].m1))
#define CSTORM_SP_STATUS_BLOCK_SIZE (IRO[134].size)
#define CSTORM_SP_SYNC_BLOCK_OFFSET(pfId) \
	(IRO[136].base + ((pfId) * IRO[136].m1))
#define CSTORM_SP_SYNC_BLOCK_SIZE (IRO[136].size)
...
#define CSTORM_SYNC_BLOCK_OFFSET(sbId) \
	(IRO[130].base + ((sbId) * IRO[130].m1))
#define CSTORM_SYNC_BLOCK_SIZE (IRO[130].size)
#define CSTORM_VF_PF_CHANNEL_STATE_OFFSET(vfId) \
	(IRO[149].base + ((vfId) * IRO[149].m1))
#define CSTORM_VF_PF_CHANNEL_VALID_OFFSET(vfId) \
	(IRO[150].base + ((vfId) * IRO[150].m1))
#define CSTORM_VF_TO_PF_OFFSET(funcId) \
	(IRO[145].base + ((funcId) * IRO[145].m1))
#define TSTORM_ACCEPT_CLASSIFY_FAILED_OFFSET (IRO[196].base)
...
#define TSTORM_INDIRECTION_TABLE_SIZE (IRO[91].size)
	...
	(IRO[255].base + ((pfId) * IRO[255].m1) + ((iscsiConBufPblEntry) \
	* IRO[255].m2))
...
#define TSTORM_ISCSI_TCP_VARS_MSB_LOCAL_MAC_ADDR_OFFSET(pfId) \
	(IRO[253].base + ((pfId) * IRO[253].m1))
#define TSTORM_MAC_FILTER_CONFIG_OFFSET(pfId) \
	(IRO[194].base + ((pfId) * IRO[194].m1))
...
#define USTORM_AGG_DATA_OFFSET (IRO[198].base)
#define USTORM_AGG_DATA_SIZE (IRO[198].size)
#define USTORM_ASSERT_LIST_INDEX_OFFSET (IRO[168].base)
#define USTORM_ASSERT_LIST_OFFSET(assertListEntry) \
	(IRO[167].base + ((assertListEntry) * IRO[167].m1))
	#define USTORM_CQE_PAGE_NEXT_VMWARE_TEMP_OFFSET(portId,clientId) \
	(IRO[197].base + ((portId) * IRO[197].m1) + ((clientId) * \
	IRO[197].m2))
#define USTORM_ETH_PAUSE_ENABLED_OFFSET(portId) \
	(IRO[176].base + ((portId) * IRO[176].m1))
#define USTORM_ETH_STATS_QUERY_ADDR_OFFSET(pfId) \
	(IRO[170].base + ((pfId) * IRO[170].m1))
#define USTORM_FCOE_EQ_PROD_OFFSET(pfId) \
	(IRO[305].base + ((pfId) * IRO[305].m1))
#define USTORM_FUNCTION_MODE_OFFSET (IRO[175].base)
#define USTORM_FUNC_EN_OFFSET(funcId) \
	(IRO[172].base + ((funcId) * IRO[172].m1))
...
#define USTORM_MEM_WORKAROUND_ADDRESS_OFFSET(pfId) \
	(IRO[174].base + ((pfId) * IRO[174].m1))
	#define USTORM_PER_COUNTER_ID_STATS_OFFSET(portId,uStatCntId) \
	(IRO[171].base + ((portId) * IRO[171].m1) + ((uStatCntId) * \
	IRO[171].m2))
	#define USTORM_RX_PRODS_E1X_OFFSET(portId,clientId) \
	(IRO[201].base + ((portId) * IRO[201].m1) + ((clientId) * \
	IRO[201].m2))
#define USTORM_RX_PRODS_E2_OFFSET(qzoneId) \
	(IRO[202].base + ((qzoneId) * IRO[202].m1))
#define USTORM_STATS_FLAGS_OFFSET(pfId) \
	(IRO[169].base + ((pfId) * IRO[169].m1))
#define USTORM_TPA_BTR_OFFSET (IRO[199].base)
#define USTORM_TPA_BTR_SIZE (IRO[199].size)
#define USTORM_VF_TO_PF_OFFSET(funcId) \
	(IRO[173].base + ((funcId) * IRO[173].m1))
...
#define XSTORM_TCP_GLOBAL_DEL_ACK_COUNTER_ENABLED_OFFSET(portId) \
	(IRO[203].base + ((portId) * IRO[203].m1))
#define XSTORM_TCP_GLOBAL_DEL_ACK_COUNTER_MAX_COUNT_OFFSET(portId) \
	(IRO[204].base + ((portId) * IRO[204].m1))
#define XSTORM_TCP_TX_SWS_TIMER_VAL_OFFSET(pfId) \
	(IRO[206].base + (((pfId)>>1) * IRO[206].m1) + (((pfId)&1) * \
	IRO[206].m2))
