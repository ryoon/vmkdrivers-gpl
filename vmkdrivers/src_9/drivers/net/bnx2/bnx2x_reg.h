...
/* [RW 10] The number of free blocks above which the brb_empty signal to
   TSEMI is asserted */
...
/* [RW 10] The number of blocks guarantied for the LB port */
...
/* [RW 7] The maximum number of pending messages; which may be stored in XX
   protection. At write the ~ccm_registers_xx_free.xx_free counter is also
   written. */
...
/* [RW 1] The destination FIC for aggregated interrupt 24 */
#define CSDM_REG_AGG_INT_FIC_24 				 0xc2198
#define CSDM_REG_AGG_INT_FIC_25 				 0xc219c
/* [RW 1] For each aggregated interrupt index whether the mode is normal (0)
   or auto-mask-mode (1) */
#define CSDM_REG_AGG_INT_MODE_0 				 0xc21b8
#define CSDM_REG_AGG_INT_MODE_1 				 0xc21bc
...
#define CSDM_REG_AGG_INT_MODE_17				 0xc21fc
#define CSDM_REG_AGG_INT_MODE_2 				 0xc21c0
#define CSDM_REG_AGG_INT_MODE_24				 0xc2218
#define CSDM_REG_AGG_INT_MODE_25				 0xc221c
#define CSDM_REG_AGG_INT_MODE_3 				 0xc21c4
#define CSDM_REG_AGG_INT_MODE_4 				 0xc21c8
#define CSDM_REG_AGG_INT_MODE_5 				 0xc21cc
...
/* [RW 1] The T bit for aggregated interrupt 1 */
#define CSDM_REG_AGG_INT_T_1					 0xc20bc
#define CSDM_REG_AGG_INT_T_2					 0xc20c0
#define CSDM_REG_AGG_INT_T_24					 0xc2118
#define CSDM_REG_AGG_INT_T_25					 0xc211c
#define CSDM_REG_AGG_INT_T_26					 0xc2120
#define CSDM_REG_AGG_INT_T_27					 0xc2124
...
/* [RW 16] The maximum value of the competion counter #5 */
#define CSDM_REG_CMP_COUNTER_MAX5				 0xc22dc
/* [RW 16] The maximum value of the competion counter #6 */
#define CSDM_REG_CMP_COUNTER_MAX6				 0xc22e0
/* [RW 16] The maximum value of the competion counter #7 */
#define CSDM_REG_CMP_COUNTER_MAX7				 0xc22e4
/* [RW 14] The start address in the internal RAM for the completion
   counters. */
...
/* [RW 14] The start address in the internal RAM for queue counters */
...
#define DORQ_REG_AGG_CMD_1					 0x170404
#define DORQ_REG_AGG_CMD_12					 0x170430
#define DORQ_REG_AGG_CMD_13					 0x170434
#define DORQ_REG_AGG_CMD_14					 0x170438
#define DORQ_REG_AGG_CMD_15					 0x17043c
#define DORQ_REG_AGG_CMD_16					 0x170440
#define DORQ_REG_AGG_CMD_17					 0x170444
#define DORQ_REG_AGG_CMD_18					 0x170448
#define DORQ_REG_AGG_CMD_19					 0x17044c
#define DORQ_REG_AGG_CMD_2					 0x170408
#define DORQ_REG_AGG_CMD_3					 0x17040c
#define DORQ_REG_AGG_CMD_32					 0x170480
#define DORQ_REG_AGG_CMD_33					 0x170484
#define DORQ_REG_AGG_CMD_34					 0x170488
#define DORQ_REG_AGG_CMD_35					 0x17048c
#define DORQ_REG_AGG_CMD_4					 0x170410
#define DORQ_REG_AGG_CMD_5					 0x170414
#define DORQ_REG_AGG_CMD_6					 0x170418
#define DORQ_REG_AGG_CMD_7					 0x17041c
...
/* [WB_R 64] Do not read from this memory if error_handling_data_valid
   register is zero. The data is collected in according to the command_debug
   value. if command_debug is clear it holds the first 8 error commands as
   follows: {wr_data[31:0]; cmd_addr[12:0]; error_type_d[3:0]; cmd_fid[6:0];
   cmd_source; error_source[1:0]; cmd_func_err; cmd_length[2:0];
   cmd_wr_n_rd} . if command_debug is set it holds the last 8 commands to
   the IGU (with and without error) as follows: {wr_data[31:0];
   cmd_addr[15:0]; 1b0; cmd_fid[6:0]; cmd_source; error_source[1:0];
   cmd_func_err; cmd_length[2:0]; cmd_wr_n_rd}. cmd_source - the source
   field in PXP command. VFID is encoded: PF? {4b1000; PFID} : {1b0; VFID}.
   error_source[1:0] - pxp - 0; grc - 1; attn - 2. cmd_func_err - func_err
   field in PXP command. cmd_length[2:0] - length in PXP command.
   cmd_wr_n_rd: 0 - read; 1 - write. error_type_d[3:0] :1 - length &gt; ; 2
   - command to disable function; 3 - VF command to attn bits. 4 - host
   tries to update prod. 5 - during read from MIMD function; 6 -segment not
   match; 7 - attn prod upd; 9 - SB index not valid; 10 - FID + vector num
   not found; 11 - FID not match; 12 - VF tries to access attn command. */
#define IGU_REG_ERROR_HANDLING_MEMORY				 0x130178
/* [R 11] Parity register #0 read */
...
#define MISC_REG_AEU_ENABLE5_FUNC_0_OUT_1			 0xa68c
/* [RW 32] Fifth 32b for enabling the output for function 1 output0. Mapped
   as follows: [0] PGLUE config_space; [1] PGLUE misc_flr; [2] PGLUE B RBC
   attention [3] PGLUE B RBC parity; [4] ATC attention; [5] ATC parity; [6]
   CNIG attention (reserved); [7] CNIG parity (reserved); [31-8] Reserved; */
#define MISC_REG_AEU_ENABLE5_FUNC_1_OUT_0			 0xa6b0
#define MISC_REG_AEU_ENABLE5_FUNC_1_OUT_1			 0xa6b4
/* [RW 32] Fifth 32b for enabling the output for close the gate nig. Mapped
   as follows: [0] PGLUE config_space; [1] PGLUE misc_flr; [2] PGLUE B RBC
   attention [3] PGLUE B RBC parity; [4] ATC attention; [5] ATC parity; [6]
   CNIG attention (reserved); [7] CNIG parity (reserved); [31-8] Reserved; */
#define MISC_REG_AEU_ENABLE5_NIG_0				 0xa6a8
/* [RW 32] Fifth 32b for enabling the output for close the gate pxp. Mapped
   as follows: [0] PGLUE config_space; [1] PGLUE misc_flr; [2] PGLUE B RBC
   attention [3] PGLUE B RBC parity; [4] ATC attention; [5] ATC parity; 6]
   CNIG attention (reserved); [7] CNIG parity (reserved); [31-8] Reserved; */
#define MISC_REG_AEU_ENABLE5_PXP_0				 0xa6ac
...
/* [RW 1] multifunction for WOL. If clr WOL signal of the PXP will be send
   on bit 0 only. Global register. Reset on hard reset. */
...
/* [RW 12] [7:0] 8 MSB of LCPLL second register. Inside order of bits: [0-4]
   capSelectM[4:0] (reset value 0) bits to vco cap value; 00000 for most cap
   and lowest frequency. [5] capForceSlowdown_en (reset value 0) bit to
   enable capForceSlowdown into capSeq. [6] capForceSlowdown (reset value 0)
   bit to force slowdown. [7] Slowdn_xor (reset value 0) bit to invert
   slowdn (added for test chip); [8] LCPLL RESET (reset value 0) RESET pin
   of the LCPLL: Reset for VCO tuning sequencer. (active high; longer than
   30 usec); [9] LCPLL BYPASS_CML (reset value 0) BYPASS_CMD pin of the
   LCPLL: Bypass mode enable (active high): 0= Normal mode; 1= Bypass mode
   (CMOS bypass clock fed thru BYPASS MUX to CML output buffers); [10] LCPLL
   BYPEN_CMOS (reset value 0) Bypass mode clock selection: 0= CMOS clock
   derived from REFP/N fed to bypass MUX; 1= CMOS clock from Byp_CLK156 is
   fed to bypass MUX; [11] LCPLL PWRDN (reset value 1) PLL power down
   (active high): 0 = Normal mode; 1 = Power down. Global register. */
...
#define MISC_REG_RESET_REG_3					 0xa5a0
...
/* [RW 1] 4-port mode control to XGXS; Hardwired ST bits LSB: 0 - clause 45;
   1 - clause 22. Drives output misc_xgxs0_mux_md_st. Global register. */
#define MISC_REG_XGXS0_CTRL_MD_ST				 0xa730
...
/* [RW 16] ADDRESS for header in PP message to PXP internal write IF */
#define NIG_REG_PPP_ADDRESS					 0x160a4
...
/* [RW 4] STORM ID for header in PP message to PXP internal write IF */
#define NIG_REG_PPP_STORM_ID					 0x160a0
/* [RW 8] T124param for header in PP message to PXP internal write IF */
#define NIG_REG_PPP_T124PARAM					 0x160ac
/* [RW 4] Trigger for header in PP message to PXP internal write IF */
#define NIG_REG_PPP_TRIG					 0x160a8
...
/* [R 32] Cyclic counter for number of 8 byte lines freed from the task
   queue of port 0. Reset upon init. */
#define PBF_REG_P0_TQ_LINES_FREED_CNT				 0x1402f0
/* [R 11] Number of 8 bytes lines occupied in the task queue of port 0. */
...
/* [R 32] Cyclic counter for number of 8 byte lines freed from the task
   queue of port 1. Reset upon init. */
#define PBF_REG_P1_TQ_LINES_FREED_CNT				 0x1402f4
/* [R 11] Number of 8 bytes lines occupied in the task queue of port 1. */
...
/* [R 32] Cyclic counter for number of 8 byte lines freed from the task
   queue of port 4. Reset upon init. */
#define PBF_REG_P4_TQ_LINES_FREED_CNT				 0x1402f8
/* [R 11] Number of 8 bytes lines occupied in the task queue of port 4. */
...
/* [RW 2] Update mode for the SYN flag */
#define PBF_REG_SYN_FLG_MODE					 0x15c0f0
...
/* [RW 32] CM header for the context error case */
#define PRS_REG_CM_CONTEXT_ERROR_HDR				 0x40264
...
/* [RW 32] CM header for the load cancelled case */
#define PRS_REG_CM_LOAD_CANCELLED_HDR				 0x40260
/* [RW 32] The CM header in case there was not a match on the connection */
#define PRS_REG_CM_NO_MATCH_HDR 				 0x400b8
/* [RW 8] Event ID for the context error case */
#define PRS_REG_CONTEXT_ERROR_EVENT_ID				 0x4025c
...
/* [RW 32] Legacy (type B) PF inbound interrupt table for CSDM:
...
/* [RW 32] Legacy (type B) PF inbound interrupt table for USDM:
   bits[31:16]-mask; its[15:0]-address. Bits [1:0] must be zero (DW
   resolution address). */
...
/* [RW 32] Legacy (type B) PF inbound interrupt table for XSDM:
   bits[31:16]-mask; its[15:0]-address. Bits [1:0] must be zero (DW
   resolution address). */
...
/* [RW 10] Bandwidth Typical L to VQ TREQ read requests */
#define PXP2_REG_RQ_BW_RD_L_TREQ				 0x120600
...
/* [RW 7] Bandwidth upper bound to VQ TREQ read requests */
#define PXP2_REG_RQ_BW_RD_UBOUND_TREQ				 0x1205fc
...
/* [RW 1] For non-USDMDP clients. 0 - working in A0 mode - assert
   has_payload only when EOP arrived;  - working in B0 mode - assert
   has_payload according to pxp2.wr_th_usdmdp or to EOP arrived. */
...
/* [RW 10] If Number of entries (each represents 16B) in usdmdp fifo is
   higher than this threshold then has_payload indication will be asserted;
   the default value should be &gt;  (MPS size * ~pxp2.wr_usdmdp_outst_req). */
...
/* [R 17] The credit value for byte credit 0 (COS 0). The value is 2s
   complement value (i.e. msb is used for the sign). */
#define QM_REG_BYTECRD0 					 0x16e6fc
/* [R 17] The credit value for byte credit 1 (COS 1). The value is 2s
   complement value (i.e. msb is used for the sign). */
#define QM_REG_BYTECRD1 					 0x16e700
/* [R 17] The credit value for byte credit 2 (Loopback). The value is 2s
   complement value (i.e. msb is used for the sign). */
#define QM_REG_BYTECRD2 					 0x16e704
/* [RW 32] the PBF command queue that each physical queue belongs to. 2 bits
   per physical queue (queues 0-15) as follows: 0 for COS0; 1 for COS 1; 2
   for Loopback */
#define QM_REG_BYTECRDCMDQ_0					 0x16e6e8
#define QM_REG_BYTECRDCMDQ_1					 0x16e6ec
#define QM_REG_BYTECRDCMDQ_2					 0x16e6f0
#define QM_REG_BYTECRDCMDQ_3					 0x16e6f4
/* [RW 16] The byte credit cost for each task. This value is for all byte
   credit counters */
#define QM_REG_BYTECRDCOST					 0x168234
/* [RC 32] Byte credit update error register; b1-b0: byte credit counter id
   (pbf error); b3-b2: byte credit counter id (storm increment error);
   b5-b4: byte credit counter id (storm decrement error); b7-b6: reserved;
   b8: pbf error valid; b9: storm increment error valid; b10: storm
   decrement error valid; b11: reserved; b14-b12: byte credit warning
   (warning=decremented below zero). mask bit per byte credit counter;
   b31-b15: reserved; */
#define QM_REG_BYTECRDERRREG					 0x16e708
/* [RW 16] The initial byte credit value for all counters */
...
#define QM_REG_QVOQIDX_2					 0x1680fc
#define QM_REG_QVOQIDX_20					 0x168144
...
#define QM_REG_QVOQIDX_4					 0x168104
...
#define QM_REG_TASKCRDCOST_3					 0x1680a8
...
/* [RW 24] The PBF command queue which is associated with each VOQ (2 bits
   per VOQ) as follows: 0 for COS0; 1 for COS1; 2 for loopback */
...
#define SRC_REG_KEYRSS0_9					 0x4042c
#define SRC_REG_KEYRSS1_0					 0x40430
...
/* [RW 6] The maximum number of pending messages; which may be stored in XX
   protection. ~tcm_registers_xx_free.xx_free is also written on write. */
...
/* [RW 16] The maximum value of the competion counter #5 */
#define TSDM_REG_CMP_COUNTER_MAX5				 0x422c4
/* [RW 16] The maximum value of the competion counter #6 */
#define TSDM_REG_CMP_COUNTER_MAX6				 0x422c8
/* [RW 16] The maximum value of the competion counter #7 */
#define TSDM_REG_CMP_COUNTER_MAX7				 0x422cc
/* [RW 14] The start address in the internal RAM for the completion
   counters. */
...
/* [RW 14] The start address in the internal RAM for the packet end message */
...
/* [RW 6] The maximum number of pending messages; which may be stored in XX
   protection. ~ucm_registers_xx_free.xx_free is also written on write. */
...
/* [RW 16] The maximum value of the competion counter #5 */
#define USDM_REG_CMP_COUNTER_MAX5				 0xc42dc
/* [RW 16] The maximum value of the competion counter #6 */
#define USDM_REG_CMP_COUNTER_MAX6				 0xc42e0
/* [RW 16] The maximum value of the competion counter #7 */
#define USDM_REG_CMP_COUNTER_MAX7				 0xc42e4
/* [RW 14] The start address in the internal RAM for the completion
   counters. */
...
/* [RW 6] The maximum number of pending messages; which may be stored in XX
   protection. ~xcm_registers_xx_free.xx_free is also written on write. */
...
#define XSDM_REG_AGG_INT_MODE_9 				 0x1661dc
/* [RW 1] The T bit for aggregated interrupt 0 */
#define XSDM_REG_AGG_INT_T_0					 0x1660b8
#define XSDM_REG_AGG_INT_T_1					 0x1660bc
#define XSDM_REG_AGG_INT_T_10					 0x1660e0
#define XSDM_REG_AGG_INT_T_14					 0x1660f0
#define XSDM_REG_AGG_INT_T_15					 0x1660f4
#define XSDM_REG_AGG_INT_T_2					 0x1660c0
#define XSDM_REG_AGG_INT_T_9					 0x1660dc
/* [RW 14] The start address in the internal RAM for the cfc_rsp lcid */
...
/* [RW 16] The maximum value of the competion counter #5 */
#define XSDM_REG_CMP_COUNTER_MAX5				 0x1662dc
/* [RW 16] The maximum value of the competion counter #6 */
#define XSDM_REG_CMP_COUNTER_MAX6				 0x1662e0
/* [RW 16] The maximum value of the competion counter #7 */
#define XSDM_REG_CMP_COUNTER_MAX7				 0x1662e4
/* [RW 14] The start address in the internal RAM for the completion
   counters. */
...
#define AEU_INPUTS_ATTN_BITS_PBCLIENT_PARITY_ERROR	      (0x1<<0)
#define AEU_INPUTS_ATTN_BITS_PBF_HW_INTERRUPT		      (0x1<<31)
...
#define MCP_PFC_ATTENTION_BIT_PORT_0\
	RESERVED_GENERAL_ATTENTION_BIT_20
#define MCP_PFC_ATTENTION_BIT_PORT_1\
...
#define PCIE_DEV_STATUS_PENDING_TRANSACTION		0x20	/*bit 5*/
