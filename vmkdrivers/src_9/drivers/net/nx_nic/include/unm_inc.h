...
#define PF_MAX_LINK_SPEED_REG(pcifn) \
         (CRB_PF_MAX_LINK_SPEED_1 + (((pcifn)/4) * 4))
...
/*
 * defines used to set dinhost in xdma_queue_request.
 */

#define XDMA_DINHOST_SRC1		0x1
#define XDMA_DINHOST_DST1		0x2
#define XDMA_DINHOST_SRC2		0x4
#define XDMA_DINHOST_DST2		0x8



/*
 * Request queue for XDMA.
 * TODO : This needs to be extracted from the firmware.
 */
