...
#define NX_CDRP_TOE_INIT        0
#define NX_CDRP_TOE_UNINIT      1
...
#define NX_CAP0_PEXQ    		    NX_CAP_BIT(0, 9)
...
#define NX_MAX_RULES_PER_PORT               16
...
#define NX_DESTROY_CTX_NO_FWCMD             3 
...
#define	MAX_FUNC_ATTR	64
struct nx_cardrsp_func_attrib {
	U64	fenable;		/* Bitmask of enabled functions */
	U8	pvport[MAX_FUNC_ATTR];	/* Hi 4 bits vport, lo 4 bits pport */
	U64	freq;			/* Filtering requirements */
};
