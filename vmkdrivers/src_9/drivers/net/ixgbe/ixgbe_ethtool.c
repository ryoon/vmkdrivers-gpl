...
#ifdef __VMKLNX__
extern void ixgbe_vf_print_eswitch_regs(struct ixgbe_adapter *adapter);
extern void ixgbe_vf_print_regs(struct ixgbe_adapter *adapter, u32 vf);
#endif
...
#ifdef __VMKLNX__
			temp_tx_ring[i].vector_idx = adapter->tx_ring[i]->vector_idx;
			temp_tx_ring[i].allocated = adapter->tx_ring[i]->allocated;
...
#ifdef __VMKLNX__
			temp_rx_ring[i].vector_idx = adapter->rx_ring[i]->vector_idx;
			temp_rx_ring[i].allocated = adapter->rx_ring[i]->allocated;
