...
#endif
#define skb_pad(x,y) _kc_skb_pad(x, y)
extern int _kc_skb_pad(struct sk_buff *skb, int pad);
#endif /* !__VMKLNX__ */
...
#endif
#ifndef __VMKLNX__
/* vmklinux has the built-in cancel_work_sync */
#define cancel_work_sync(x) flush_scheduled_work()
#endif /* !__VMKLNX__*/
#ifndef udp_hdr
...
/* our driver need to call vmklinux's netif_napi_del */
#ifndef __VMKLNX__
