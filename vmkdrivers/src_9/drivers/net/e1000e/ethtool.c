...
/*
 * PR 624672: Since device_set_enable_wakeup()/friends is stubbed out
 * on ESX 5.0, device_can_wakeup() will always return FALSE 
 * irrespective of whether the device supports WOL or not. 
