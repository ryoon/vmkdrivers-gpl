	...
	{ /* EEE -  Enable EEE for capable adapters */
		...
		if (hw->mac.type >= e1000_i350) {
			struct igb_option opt = {
				...
				.name = "EEE Support",
#ifdef __VMKLNX__
	/* It's found on some i350 LOM the link goes down without any errors
	 * or changes in kernel or external conditions. With experiments,
	 * EEE is found as the root cause. So disable EEE on i350 by default.
	 */
				.err  = (hw->mac.type == e1000_i350 ?
					"defaulting to Disabled" :
					"defaulting to Enabled"),
				.def  = (hw->mac.type == e1000_i350 ?
					OPTION_DISABLED :
					OPTION_ENABLED),
#else
				.err  = "defaulting to Enabled",
