 ...
 */
int
qla2x00_set_rnid_params_mbx(scsi_qla_host_t *vha, dma_addr_t buf_phys_addr,
 ...
 */
int
qla2x00_get_rnid_params_mbx(scsi_qla_host_t *vha, dma_addr_t buf_phys_addr,
    size_t buf_size, uint16_t *mb_reg)
{
	int		rval;
	mbx_cmd_t	mc;
...
__qla2x00_lun_reset(scsi_qla_host_t *vha, fc_port_t *fcport, uint16_t lun, int tag)
{
	...
	if (IS_QLA24XX_TYPE(ha) || IS_QLA54XX(ha) || 
...
int
qla81xx_get_xgmac_stats(scsi_qla_host_t *vha, dma_addr_t stats_dma,
...
int
qla81xx_get_dcbx_params(scsi_qla_host_t *vha, dma_addr_t tlv_dma,
    uint16_t size)
{
	int rval;
	mbx_cmd_t mc;
