 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_crc_check */
 ...
 */
/* _VMKLNX_CODECHECK_: _fc_frame_alloc */
struct fc_frame *_fc_frame_alloc(size_t len)
{
	...
	/*
	 * Underlying skb frag pages are owned by VMkernel.
	 */
...
/* _VMKLNX_CODECHECK_: fc_frame_alloc_fill */
