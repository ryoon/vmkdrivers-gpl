 ...
 */
/* _VMKLNX_CODECHECK_: __ata_ehi_push_desc */
 ...
 *	None.
 */
/* _VMKLNX_CODECHECK_: ata_port_pbar_desc */
 ...
 *	Number of aborted qc's.
 */
/* _VMKLNX_CODECHECK_: ata_port_abort */
 ...
 */
/* _VMKLNX_CODECHECK_: ata_port_freeze */
 ...
 */
/* _VMKLNX_CODECHECK_: sata_async_notification */
...
static unsigned int atapi_eh_request_sense(struct ata_queued_cmd *qc)
{
	...
	unsigned int rc;
	rc = ata_exec_internal(dev, &tf, cdb, DMA_FROM_DEVICE,
			       qc->sense_buffer, SCSI_SENSE_BUFFERSIZE, 0);
	memcpy(sense_buf, qc->sense_buffer, 
