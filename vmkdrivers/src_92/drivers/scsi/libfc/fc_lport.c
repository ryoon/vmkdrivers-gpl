 ...
 */
/* _VMKLNX_CODECHECK_: fc_get_host_port_type */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_get_host_port_state */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_get_host_speed */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_get_host_stats */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_fabric_login */
 ...
 */
/* _VMKLNX_CODECHECK_: __fc_linkup */
 ...
 * Locking: must be called with the lp_mutex held
 */
/* _VMKLNX_CODECHECK_: __fc_linkdown */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_linkdown */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_fabric_logoff */
 ...
 *
 */
/* _VMKLNX_CODECHECK_: fc_lport_destroy */
 ...
 *		 lport lock held.
 */
/* _VMKLNX_CODECHECK_: fc_lport_reset */
			     ...
			     void *lp_arg)
{
	...
	FC_LPORT_DBG(lport, "Received a ns %s lport state x%x"
		     "ct_cmd x%x ct_reason x%x ct_explan x%x\n",
		     fc_els_resp_type(fp), lport->state,
		     ct->ct_cmd, ct->ct_reason, ct->ct_explan);
...
static void fc_lport_enter_ns(struct fc_lport *lport, enum fc_lport_state state)
{
	...
	FC_LPORT_DBG(lport, "Entered %s state from %s state "
		     "port ID x%x wwnn x%llx wwpn x%llx\n",
		     fc_lport_state_names[state],
		     fc_lport_state(lport),
		     fc_host_port_id(lport->host), lport->wwnn, lport->wwpn);
 ...
 * and then unlock the lport.
 */
/* _VMKLNX_CODECHECK_: fc_lport_logo_resp */
 ...
 * and then unlock the lport.
 */
/* _VMKLNX_CODECHECK_: fc_lport_flogi_resp */
			 ...
			 void *lp_arg)
{
	...
	if (fc_frame_payload_op(fp) == ELS_LS_ACC && did) {
		...
		u8 *r = fc_frame_payload_get(fp, 8);
		if(r) {
			FC_LPORT_DBG(lport, "Bad FLOGI response %s "
			       "%x, %x, %x, %x, %x, %x, %x, %x\n",
			     fc_els_resp_type(fp),
 ...
 */
/* _VMKLNX_CODECHECK_: fc_lport_config */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_lport_init */
 ...
 * @job: The BSG passthrough job
 */
/* _VMKLNX_CODECHECK_: fc_lport_bsg_request */
