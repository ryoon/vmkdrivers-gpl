 ...
 */
/* _VMKLNX_CODECHECK_: fc_elsct_send */
			     ...
			     void *arg, u32 timer_msec)
{
	...
	int rc;
	u32 sid = fc_host_port_id(lport->host);
	...
	/*
	 * Force SID to be zero for FLOGI to work on FABRIC lports.
	 * Exclude VN2VN lports as they already know which S_ID to use.
	 */
	...
	fc_fill_fc_hdr(fp, r_ctl, did, sid, fh_type,
 ...
 */
/* _VMKLNX_CODECHECK_: fc_elsct_init */
