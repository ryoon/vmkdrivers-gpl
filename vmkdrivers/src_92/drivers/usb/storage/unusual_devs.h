...
UNUSUAL_DEV(  0x046b, 0xff90, 0x0000, 0x9999,
		"DELL  INC.",
		"iDRAC",
		USB_SC_DEVICE, USB_PR_DEVICE, NULL,
		US_FL_VMKLNX_NO_FILTERING | US_FL_VMKLNX_NO_UNCLAIM),

UNUSUAL_DEV(  0x046b, 0xff91, 0x0000, 0x9999,
		"DELL  INC.",
		"iDRAC",
		USB_SC_DEVICE, USB_PR_DEVICE, NULL,
		US_FL_VMKLNX_NO_FILTERING | US_FL_VMKLNX_NO_UNCLAIM),

UNUSUAL_DEV(  0x046b, 0xff92, 0x0000, 0x9999,
		"DELL  INC.",
		"iDRAC",
		USB_SC_DEVICE, USB_PR_DEVICE, NULL,
		US_FL_VMKLNX_NO_FILTERING | US_FL_VMKLNX_NO_UNCLAIM),
