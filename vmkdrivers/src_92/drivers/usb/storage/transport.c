...
#if defined(__VMKLNX__)
	/*
	 * If we are panicking we should use atomic memory allocation,
	 * otherwise our memory allocator will be unhappy. This should
	 * actually be fixed in the allocator itself, but for now we
