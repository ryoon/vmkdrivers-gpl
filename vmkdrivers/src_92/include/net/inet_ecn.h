...
/**                                          
 *  INET_ECN_is_ce - Checks if CE codepoint is set.
 *  @dsfield: IP Differentiated services field.
 *                                           
 *  Tests if the "Congestion Experienced" codepoint is set.
 *                                           
 *  RETURN VALUE:
 *  Returns non-zero if CE codepoint is set and 0 otherwise.
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: INET_ECN_is_ce */
