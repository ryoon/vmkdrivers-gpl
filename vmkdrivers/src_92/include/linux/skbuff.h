 ...
 *  @priority: allocation priority
 *
 *  Allocate a new &sk_buff from the fclone case instead of head cache.
 *  The returned buffer has no headroom and a tail room of size bytes.
 *  The object has a reference count of one. The return is the buffer.
 *  On a failure the return is NULL. Buffers may only be allocated from
...
/**
 * skb_queue_head_init - Initialize the socket buffer queue
...
/**
 *  __skb_unlink - Remove a buffer from a list
 *  @skb: socket buffer to remove
 *  @list: list to use
 *
 *  Remove a packet from a list. This function does NOT take any locks
...
/**
 *  skb_is_nonlinear - Fetch the socket buffer data length
 *  @skb: socket buffer
 *
 *  Fetch the socket buffer data length. Generally used to check if
 *  skb data exists.
 *
 *  RETURN VALUE:
 *  socket buffer data length
 *
 */
...
/**
 * skb_transport_header - Fetch the socket bufer header data
 * @skb: socket buffer
 *
 * Fetch the socket buffer header raw data.
 *
 * RETURN VALUE:
 * sk_buff header data
 *
...
/**
 * skb_reset_network_header - Reset the socket buffer network header
 * @skb: socket buffer
 *
 * Reset the socket buffer network header raw data with skb->data
 *
 * RETURN VALUE:
 * NONE
 */
...
/**
 *  skb_reset_mac_header - Reset skb mac data
 *  @skb: socket buffer
 *
 *  Reset the socket buffer mac raw data to skb->data
 *
 *  RETURN VALUE:
 *  NONE
 *
