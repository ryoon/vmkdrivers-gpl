...
/**                                          
 *  page_cache_release - releases a page
 ...
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: page_cache_release */
#define page_cache_release(page)	put_page(page)

/**                                          
 *  page_cache_alloc - allocates a page
 *  @x: address space
 *             
 *  ESX Deviation Notes:                     
 *  None.
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: page_cache_alloc */
...
/**                                          
 *  page_cache_alloc - allocates a page enforcing gfp cold option
 *  @x: address space
 *             
 *  ESX Deviation Notes:                     
 *  None.
 *                                           
 */                                          
/* _VMKLNX_CODECHECK_: page_cache_alloc_cold */
