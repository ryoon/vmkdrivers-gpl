 ...
 */
/* _VMKLNX_CODECHECK_: fcoe_dev_from_skb */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_init */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_alloc */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_free */
static inline void fc_frame_free(struct fc_frame *fp)
{
#if defined(__VMKLNX__)
	if (IS_ERR(fp))
		return; // don't free if frame is invalid
#endif
	kfree_skb(fp_skb(fp));
}

/* _VMKLNX_CODECHECK_: fc_frame_is_linear */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_header_get */
static inline
 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_payload_get */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_payload_op */
 ...
 */
/* _VMKLNX_CODECHECK_: fc_frame_class */
