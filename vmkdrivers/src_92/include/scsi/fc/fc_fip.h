 ...
 * http://www.t11.org/ftp/t11/pub/fc/bb-6/10-019v4.pdf	(VN2VN proposal)
 */
...
#define FIP_FCF_FUZZ	100	/* random time added by FCF (mS) */
 ...
 /*
 * XXX VN2VN proposed-standard values only.  Verify later.
 */
...
#define FIP_ALL_VN2VN_MACS	((u8[6]) { 1, 0x10, 0x18, 1, 0, 4 })
#define FIP_ALL_P2P_MACS	((u8[6]) { 1, 0x10, 0x18, 1, 0, 5 })
...
enum fip_opcode {
	...
	FIP_OP_VN2VN =	5,		/* VN2VN operation */ /* XXX proposed */
...
enum fip_flag {
	...
	FIP_FL_P2P =	0x0008,		/* point-to-point (not multipoint) */
