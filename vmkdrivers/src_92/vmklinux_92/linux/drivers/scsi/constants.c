 ...
 *  @key: key value 
 *                                           
 *  Gets sense key string
 *                                           
 *  Return Value: 
 *  Sense key string or NULL if not available                                           
 */                                          
/* _VMKLNX_CODECHECK_: scsi_sense_key_string */
const char *
 ...
 */
/**                                          
 *  scsi_extd_sense_format - get the additional sense codes description string
 *  @asc: additional sense code    
 *  @ascq: additional sense code qualifier   
 *                                           
 *  Return the additional sense codes description string based on
 *  additional sense code and additional sense code qualifier. 
 *                                           
 *	RETURN VALUE:
 *	A const char * to the descrition string if asc is valid, otherwise NULL.
 */                                          
/* _VMKLNX_CODECHECK_: scsi_extd_sense_format */
const char *
...
/**                                          
 *  scsi_print_command - print the CDB of a scsi command       
 *  @cmd: scsi command    
 *                                           
 *  Print the CDB of a scsi command                       
 *                                           
 *  RETURN VALUE:
 *  None
 */                                          
/* _VMKLNX_CODECHECK_: scsi_print_command */
